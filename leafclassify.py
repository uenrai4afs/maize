...
def predict(image):
    ...
    labels = {0: "fall armyworm", 1: "grasshoper", 2: "healthy", 3: "leaf beetle", 4: "leaf blight", 5:"leaf spot", 6: "streak virus" }
    label_new=[ "fall armyworm", "grasshoper", "healthy", "leaf beetle", "leaf blight","leaf spot", "streak virus" ]
